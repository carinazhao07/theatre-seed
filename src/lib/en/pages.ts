...
export const joinEn = {
  ...
  contact: {
    ...
    wechatLabel: "WeChat ·",
    wechat: siteEn.wechat,
    note: "Application forms, mentor volunteer info, and sponsorship materials can be shared after we connect. A written project overview is available on request.",
